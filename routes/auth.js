...
router.post('/login', async (req, res) => {
    try {
        ...
        // Render에 설정한 ADMIN_EMAIL로 로그인할 때 기존 일반 계정도 ADMIN으로 자동 승격/갱신한다.
...
router.post('/register-shop', async (req, res) => {
    try {
        ...
        try {
            ...
            const shopResult = await client.query(`INSERT INTO shops (user_id,shop_name,business_number,address,detail_address,latitude,longitude,phone,description) VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9) RETURNING *`, [userId, shop_name, business_number, address, detail_address, latitude, longitude, shop_phone, description]);
